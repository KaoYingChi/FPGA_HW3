...
HD_PWD='C:/Users/User/Desktop/VVV/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ppl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ppl.tcl
