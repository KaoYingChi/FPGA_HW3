...
HD_PWD='C:/Users/User/Desktop/VVV/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ppl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ppl.tcl -notrace
